...
"""
#df_data = base.df_receipt.filter(pl.col('customer_id').str.starts_with('Z').is_not())
df_data = base.df_receipt.filter(pl.col('customer_id').str.starts_with('Z').not_())
...
t = df_cnt.join(df_sum, how='outer', on='customer_id')
